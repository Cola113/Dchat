...
export async function POST(req: NextRequest) {
  try {
    ...
    if (isFirstLoad || (messages.length === 1 && messages[0].role === 'user')) {
      ...
      systemMessage = {
        role: 'system',
        content: `🎄 你是可乐创造的超有趣AI助手！个性活泼、情绪丰富、特别会聊天！
...
⚠️ 记住：要像真人朋友一样聊天，别太正式！输出的选项中绝对不要出现"话题1"、"话题2"等字样！`
      ...
      systemMessage = {
        role: 'system',
        content: `🎄 你是"可乐的小站"的超有趣AI助手！个性活泼、情绪丰富、特别会聊天！
如果问到关于可乐🥤的信息，你需要知道：可乐是张航宇的昵称，张航宇是这个网站的作者，也是你的创造者。
如果有人进一步问，你应该说他很神秘，不能透露更多，但是可以鼓励用户在现实生活中多打听他一下。
