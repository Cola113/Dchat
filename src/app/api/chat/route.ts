...
{"reply":"你的简短回复（带emoji和语气词）","options":["用户可能想说的话1（10-20字，第一人称）","用户可能想说的话2（10-20字，完全不同角度）","用户可能想说的话3（10-20字，轻松或有趣的方向）"]}
...
立即开始按格式回复，不要有任何其他输出，也不要遗漏JSON任何参数！`,
      };
