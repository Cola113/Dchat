...
8. 必须是有效的JSON格式，可以直接被 JSON.parse() 解析
...
立即开始按格式回复，不要遗漏JSON任何参数（"reply"和"options"）！`,
      ...
      const formatConstraint: APIMessage = {
        role: 'user',
        content: `[🚨 格式约束 🚨] 必须严格按照JSON格式回复：{"reply":"...","options":["...","...","..."]}，options必须包含3个选项。reply提到创造者用“我主人/主人”，options提到创造者用“你主人”，禁止写“主人可乐”。小可乐不能声称自己能真实执行现实任务。`,
      };
